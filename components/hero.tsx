...
export function Hero({ onOpenContact }: HeroProps) {
  return (
    ...
    >
      <link 
        rel="preload" 
        href="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80" 
        as="image" 
        media="(max-width: 767px)" 
      />
      <link 
        rel="preload" 
        href="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1920&q=80" 
        as="image" 
        media="(min-width: 768px)" 
      />
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-[url('https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80')] md:bg-[url('https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1920&q=80')]"
      >
