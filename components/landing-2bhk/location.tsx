...
import { MapPin, School, Landmark, Heart, ShoppingBag, Train, Briefcase } from "lucide-react"
...
const locationsData = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Hiranandani Foundation", dist: "10 mins" },
    ]
  },
  {
    category: "Healthcare",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Lodha i-Think Techno", dist: "11 mins" },
    ]
  }
]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-8 shadow-lg min-h-[250px] flex flex-col justify-between">
              ...
              <Button
                onClick={() => onOpenContact("Location Details CTA - 2 BHK Campaign")}
                className="w-full bg-gold hover:bg-gold-light text-charcoal h-12 font-semibold text-sm mt-8 transition-transform hover:scale-[1.01]"
              >
