      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <motion.div
            ...
            className="group relative rounded-2xl border border-border bg-card p-8 flex flex-col justify-between hover:border-gold/30 transition-[border-color,box-shadow] shadow-md"
          >
            <div>
