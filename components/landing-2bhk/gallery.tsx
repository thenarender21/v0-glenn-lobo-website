...
const galleryCategories = [
  {
    ...
    name: "Exterior Views",
    images: [
      { src: "/images/raunak-max-city-2bhk/image_1.webp", caption: "Premium Tower Exterior Render" },
      { src: "/images/raunak-max-city-2bhk/image_2.webp", caption: "Township Entrance & Plaza" },
      { src: "/images/evening_view.webp", caption: "Twilight Exterior Landscape View" },
    ]
  },
  {
    id: "living",
    name: "Living Room",
    images: [
      { src: "/images/raunak-max-city-2bhk/image_3.webp", caption: "Spacious Premium 2 BHK Living Area" },
      { src: "/images/raunak-max-city-2bhk/image_4.webp", caption: "Living Area & Adjoining Dining Room" },
    ]
  },
  {
    id: "bedrooms",
    name: "Bedrooms",
    images: [
      { src: "/images/raunak-max-city-2bhk/image_5.webp", caption: "Master Bedroom with Premium Fittings" },
      { src: "/images/raunak-max-city-2bhk/image_6.webp", caption: "Kids Bedroom / Dedicated Study Room" },
    ]
  },
  {
    id: "kitchen",
    name: "Kitchen",
    images: [
      { src: "/images/raunak-max-city-2bhk/image_7.webp", caption: "Modern Semi-Modular Kitchen Setup" },
      { src: "/images/raunak-max-city-2bhk/image_8.webp", caption: "Kitchen Counter & Utility Balcony Area" },
    ]
  },
  {
    id: "amenities",
    name: "Amenities",
    images: [
      { src: "/images/Swimming_pool_02.webp", caption: "Luxury Swimming Pool & Deck Area" },
      { src: "/images/Club_house.webp", caption: "State-of-the-Art Gymnasium & Fitness Center" },
      { src: "/images/children_play_area.webp", caption: "Kids Safety Play Park" },
    ]
  },
  {
    id: "common",
    name: "Common Areas",
    images: [
      { src: "/images/raunak-max-city-2bhk/image_9.webp", caption: "Double-Height Lift Lobby & Lounge" },
      { src: "/images/raunak-max-city-2bhk/image_10.webp", caption: "Rooftop Leisure Deck & Skyline Views" },
      { src: "/images/Cam_03.webp", caption: "Podium Level Landscaped Lawn" },
    ]
  }
]
