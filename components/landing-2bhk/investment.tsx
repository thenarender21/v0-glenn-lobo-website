          ...
          {investmentPoints.map((point, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-xl border border-white/10 bg-charcoal-light/45 p-6 flex flex-col justify-between hover:border-gold/30 hover:bg-charcoal-light/60 transition-[border-color,background-color] duration-300"
              >
                <div>
                  {/* Icon */}
