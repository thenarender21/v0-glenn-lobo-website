...
export function Hero({ onOpenContact }: { onOpenContact?: () => void }) {
  ...
  return (
    <section className="relative flex min-h-[95vh] items-center justify-center overflow-hidden py-16 lg:py-24">
      <link 
        rel="preload" 
        href="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=800&auto=format&fit=crop" 
        as="image" 
        media="(max-width: 767px)" 
      />
      <link 
        rel="preload" 
        href="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=1920&auto=format&fit=crop" 
        as="image" 
        media="(min-width: 768px)" 
      />
      {/* Background image & overlay */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat z-0 bg-[url('https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=800&auto=format&fit=crop')] md:bg-[url('https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=1920&auto=format&fit=crop')]"
      >
