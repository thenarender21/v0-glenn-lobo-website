          ...
          {benefits.map((benefit, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-2xl border border-border bg-card p-8 transition-[border-color,transform,box-shadow] duration-300 hover:border-gold/45 hover:shadow-xl hover:translate-y-[-4px]"
              >
                {/* Glow Element */}
