...
const amenitiesList = [
  ...
  { name: "Community Spaces", icon: HeartHandshake, desc: "Shaded seating decks and open-air decks for social chats." },
  { name: "Dedicated Visitor Parking", icon: Car, desc: "Safe and spacious parking zones designated for guests and visitors." },
]
