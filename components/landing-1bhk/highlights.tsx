          ...
          {highlights.map((highlight, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-xl border border-white/10 bg-charcoal-light/50 p-6 flex flex-col items-center text-center transition-[border-color,background-color,box-shadow] duration-300 hover:border-gold/30 hover:bg-charcoal-light/80 hover:shadow-xl"
              >
                {/* Gold Top Accent */}
