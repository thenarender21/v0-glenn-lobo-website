...
export function LandingHero() {
  ...
  return (
    <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden">
      ...
      />
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-[url('https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?q=80&w=800&auto=format&fit=crop')] md:bg-[url('https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?q=80&w=1920&auto=format&fit=crop')]"
      >
