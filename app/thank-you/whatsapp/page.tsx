...
import { MessageCircle, ExternalLink, Home } from "lucide-react"
import { Navigation } from "@/components/navigation"
import { Footer } from "@/components/footer"
import { useProperties } from "@/components/properties-provider"
import { PropertyCard } from "@/components/property-card"
import { Button } from "@/components/ui/button"
import { DEFAULT_WHATSAPP_URL, trackWhatsAppClick } from "@/lib/navigation-helpers"
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <div className="mb-6 p-4 rounded-full bg-gold/5 flex items-center justify-center">
              <MessageCircle className="size-16 text-gold animate-pulse" />
            </div>
            ...
            <p className="text-lg font-medium text-gold mb-6">
              Opening your chat session with Mukund Thakur.
            </p>
            
            <p className="text-muted-foreground text-base max-w-2xl leading-relaxed mb-8">
              Thank you for reaching out! We are redirecting you to WhatsApp. If the chat window did not open automatically, please click the button below to start messaging us directly.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full justify-center items-center">
              ...
              >
                <Button className="bg-emerald-600 text-white hover:bg-emerald-500 w-full flex items-center justify-center gap-2" size="lg">
                  Start Chat Now
